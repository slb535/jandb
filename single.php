			...
			<article>
				<h2><?php the_title(); ?></h2>   
                                   ...
                                   ?>
                                         ...
                                         <?php if (class_exists('MultiPostThumbnails')) : MultiPostThumbnails::the_post_thumbnail(get_post_type(), 'secondary-image', NULL,  'add-news-image-thumbnail', array('class' => 'post-thumbnail'), true); endif; ?>
