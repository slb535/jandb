...
/************************************************************
 Adding custom meta boxes for posts. Using the included js
 file, specific meta boxes will only be shown if the post
 is using the correct post format.
************************************************************/
if(is_admin()) {
    wp_enqueue_script('custom-meta-boxes', get_template_directory_uri() . '/includes/functions/custom-meta-boxes.js', array('jquery'),'', true);
}
